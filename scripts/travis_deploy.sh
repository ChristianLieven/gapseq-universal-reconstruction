...
if [[ "${TRAVIS_PULL_REQUEST}" != "false" || "${TRAVIS_REPO_SLUG}" != "jotech/gapseq-universal-reconstruction" ]]; then
...
echo "Your new report will be visible at https://jotech.github.io/gapseq-universal-reconstruction in a moment."
